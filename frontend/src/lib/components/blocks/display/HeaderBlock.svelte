<!-- frontend/src/lib/components/blocks/display/HeaderBlock.svelte -->
<script lang="ts">
...
<section class="py-12 md:py-16">
	<div class="container mx-auto px-4 max-w-4xl">
		<div class="text-center">
			...
			{:else if data.level === 'h2'}
				<h2 class="{headingClasses} text-gray-900 mb-4">
					{data.heading}
				</h2>
			{:else if data.level === 'h3'}
				<h3 class="{headingClasses} text-gray-900 mb-4">
					{data.heading}
				</h3>
			{:else if data.level === 'h4'}
				<h4 class="{headingClasses} text-gray-900 mb-4">
					{data.heading}
				</h4>
			{:else if data.level === 'h5'}
				<h5 class="{headingClasses} text-gray-900 mb-4">
					{data.heading}
				</h5>
			{:else}
				<h6 class="{headingClasses} text-gray-900 mb-4">
					{data.heading}
				</h6>
			{/if}
