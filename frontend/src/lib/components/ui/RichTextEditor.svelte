...
<script lang="ts">
	...
	import { CodeXml, ImageIcon, List, ListOrdered, Minus, Quote, Undo2, Redo2 } from 'lucide-svelte';
...
<div class="overflow-hidden rounded-lg border bg-surface {className}">
	{#if editor}
		<div class="flex flex-wrap items-center gap-2 border-b bg-surface p-2" data-ui={ui}>
			<select
				class="h-8 min-w-44 rounded border border-input-border bg-surface px-2 text-sm hover:bg-black/75 focus:ring-2 focus:ring-blue-500 focus:outline-none"
			...
			<div class="inline-flex overflow-hidden rounded border border-input-border bg-surface">
				<button
					type="button"
					class="px-3 py-1 transition-colors hover:bg-black/75 disabled:cursor-not-allowed disabled:opacity-50"
				...
				<button
					type="button"
					class="border-l px-3 py-1 transition-colors hover:bg-black/75 disabled:cursor-not-allowed disabled:opacity-50"
			...
			<div class="inline-flex overflow-hidden rounded border border-input-border bg-surface">
				<button
					type="button"
					class="px-3 py-1 transition-colors hover:bg-black/75"
				...
				<button
					type="button"
					class="border-l px-3 py-1 transition-colors hover:bg-black/75"
	...
	<div class="bg-surface" bind:this={element} {id}></div>
</div>
